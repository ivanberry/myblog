...
class TestUsersService(BaseTestCase):
    ...
    def test_main_with_users(self):
        '''Ensure correct data feed back with users'''
        add_user('tab', 'tab@gmail.com')
        add_user('shirting', 'shirting@gmail.com')
        ...
        self.assertIn(b'<strong>tab</strong>', response.data)
        self.assertIn(b'<strong>shirting</strong>', response.data)

    def test_main_add_users(self):
        '''Ensure correctly feed back when add user'''
        with self.client:
            response = self.client.post(
                '/',
